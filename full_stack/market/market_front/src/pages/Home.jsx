...
const Home = () => {
    return (
        <>
            <Container display="flex" backgroundColor="yellow" margin="30px auto 10px" flexDirection="column">
            ...
            <Container display="flex" backgroundColor="khaki" margin="10px auto" gap="10px">
                <Section backgroundColor='lightgray' flexGrow="1">hi</Section>
                <Section flexGrow="2">hi</Section>
            </Container>
        </>
    )
}
