...
const directions = ['북 (N)', '북동 (NE)', '동 (E)', '남동 (SE)', '남 (S)', '남서 (SW)', '서 (W)', '북서 (NW)']

export const weathers = [Thunderstorm, Drizzle, Rain, Snow, Atmosphere, Clear, Clouds, Extreme]
...
export function getWeatherScript(weather, wind) {
   ...
   return {
      ...
      description: selectedWeather.id[weather[0]?.id]?.korean || '정보 없음',
      direction,
   }
}
